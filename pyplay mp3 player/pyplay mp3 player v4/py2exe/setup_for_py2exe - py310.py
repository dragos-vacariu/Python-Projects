...
try:
    ...
    raise SystemExit("Unable to load module. " + str(exp))
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "pyplay_mp3player_py34.py"

        #Name of program
        self.project_name = "PyPlay Mp3 Player"
        ...
        #Auhor of program
        self.author_name = "Dragos Vacariu"
        self.author_email = "dragos.vacariu@mail.com"
        self.copyright = "Copyright (c) 2025 Dragos Vacariu."
    ...
    def run(self):
        ...
        setup(
            ...
            version = '4.0',
            description = 'MP3 Music Player developed using Python 3.10',
            ...
            windows = [{
                'script': self.script,
                'icon_resources': [(0, 'headphone.ico'), (1, 'player_icon.ico'), (2, 'headphone_white.ico'),  (3, 'headphone_red.ico'),  (4, 'headphone_blue.ico')],
                'copyright': "Dragos Vacariu @ 2025"
            }],
