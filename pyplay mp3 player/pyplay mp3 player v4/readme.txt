...
BUILD_EXECUTABLE_WITH_PYINSTALLER_PY310.bat can be used to build and executable from this script.
The output and the resources/backup directories need to be placed in the same folder.
